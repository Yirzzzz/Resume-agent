...
export class TemplatesService {
  ...
  renderHtml(resume: Resume, templateId: string, layout?: LayoutOptions) {
    ...
    const sectionTitleBottomPx = Math.max(5, Math.round(blockGapPx * 0.75));
